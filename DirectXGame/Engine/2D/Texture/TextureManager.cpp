...
//	texture.cpuDescHandleSRV = DirectXCommon::GetInstance()->GetSRV()->GetHeap()->GetCPUDescriptorHandleForHeapStart();
//	texture.gpuDescHandleSRV = DirectXCommon::GetInstance()->GetSRV()->GetHeap()->GetGPUDescriptorHandleForHeapStart();
//
//	// 先頭は使われているためその次
//	texture.cpuDescHandleSRV.ptr += handle * static_cast<uint32_t>(sDescriptorHandleIncrementSize_);
//	texture.gpuDescHandleSRV.ptr += handle * static_cast<uint32_t>(sDescriptorHandleIncrementSize_);
//
//	// metaDataを基にSRVの設定
