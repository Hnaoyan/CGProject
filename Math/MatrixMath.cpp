...
Matrix4x4 MatrixMath::MakeAffineMatrix(
...
Matrix4x4 MatrixMath::MakeInverse(const Matrix4x4& m) {
	Matrix4x4 result = {};
	float det = 0;
...
Matrix4x4 MatrixMath::MakeScaleMatrix(const Vector3& translate) {
	Matrix4x4 result = {};
...
Matrix4x4
    MatrixMath::MakePerspectiveFovMatrix(float fovY, float aspectRatio, float nearClip, float farClip) {
	Matrix4x4 result = {};
...
Matrix4x4 MatrixMath::MakeOrthographicMatrix(
...
Matrix4x4 MatrixMath::MakeViewportMatrix(
...
Vector3 MatrixMath::GetWorldPosition(const Matrix4x4& matWorld) {
	Vector3 worldPos;
...
Vector3 MatrixMath::TransformNormal(const Vector3& v, const Matrix4x4& mat)
{
	Vector3 result{
